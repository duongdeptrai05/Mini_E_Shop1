...
object SampleData {
    fun getSampleProducts(): List<ProductEntity> {
        return listOf(
            ProductEntity(
                id = 1, name = "iPhone 14 Pro", brand = "Apple", category = "Điện thoại",
            ...
            ProductEntity(
                id = 2, name = "Samsung Galaxy S23 Ultra", brand = "Samsung", category = "Điện thoại",
            ...
            ProductEntity(
                id = 4, name = "Dell XPS 15", brand = "Dell", category = "Laptop",
            ...
            ProductEntity(
                id = 5, name = "Sony WH-1000XM5", brand = "Sony", category = "Tai nghe",
            ...
            ProductEntity(
                id = 6, name = "Apple Watch Series 8", brand = "Apple", category = "Đồng hồ",
            ...
            ProductEntity(
                id = 7, name = "Logitech MX Master 3S", brand = "Logitech", category = "Phụ kiện",
            ...
            ProductEntity(
                id = 8, name = "Canon EOS R6 Mark II", brand = "Canon", category = "Máy ảnh",
            ...
            ProductEntity(
                id = 9, name = "Nintendo Switch OLED", brand = "Nintendo", category = "Gaming",
            ...
            ProductEntity(
                id = 10, name = "GoPro HERO11 Black", brand = "GoPro", category = "Máy ảnh",
            ...
            ProductEntity(
                id = 11, name = "iPad Pro M2", brand = "Apple", category = "Tablet",
            ...
            ProductEntity(
                id = 12, name = "Samsung Odyssey G9", brand = "Samsung", category = "Màn hình",
            ...
            ProductEntity(
                id = 13, name = "AirPods Pro (2nd gen)", brand = "Apple", category = "Tai nghe",
            ...
            ProductEntity(
                id = 14, name = "Razer BlackWidow V4 Pro", brand = "Razer", category = "Bàn phím",
            ...
            ProductEntity(
                id = 15, name = "Anker 737 Power Bank", brand = "Anker", category = "Phụ kiện",
            ...
            ProductEntity(
                id = 16, name = "Google Pixel 7 Pro", brand = "Google", category = "Điện thoại",
            ...
            ProductEntity(
                id = 17, name = "Bose QuietComfort Earbuds II", brand = "Bose", category = "Tai nghe",
            ...
            ProductEntity(
                id = 18, name = "Kindle Paperwhite", brand = "Amazon", category = "Tablet",
            ...
            ProductEntity(
                id = 19, name = "Elgato Stream Deck MK.2", brand = "Elgato", category = "Phụ kiện",
            ...
            ProductEntity(
                id = 20, name = "Sony a7 IV", brand = "Sony", category = "Máy ảnh",
